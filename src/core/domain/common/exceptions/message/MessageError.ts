...
export class MessageError {
    static SOMETHING_WRONG = new ErrorObject(
    ...
    static PARAM_NOT_SUPPORTED = new ErrorObject(
        ErrorCode.NOT_SUPPORTED,
        'The {0} is not supported!',
    );

    static ACCESS_DENIED = new ErrorObject(
        ErrorCode.ACCESS_DENIED,
        'Access is denied!',
    );

    static DATA_NOT_FOUND = new ErrorObject(
        ErrorCode.DATA_NOT_FOUND,
        'Data not found!',
    );

    static PARAM_NOT_FOUND = new ErrorObject(
        ErrorCode.DATA_NOT_FOUND,
        'The {0} was not found!',
    );

    static DATA_CANNOT_SAVE = new ErrorObject(
    ...
    static PARAM_REQUIRED = new ErrorObject(
    ...
    static PARAM_EXISTED = new ErrorObject(
        ErrorCode.DATA_EXISTED,
        'The {0} is already existed!',
    );

    static PARAM_SENT = new ErrorObject(
        ErrorCode.DATA_SENT,
        'The {0} has been sent!',
    );

    static PARAM_NOT_EXISTS = new ErrorObject(
        ErrorCode.DATA_NOT_EXISTS,
        'The {0} is not exists!',
    );

    static PARAM_EXPIRED = new ErrorObject(
        ErrorCode.DATA_EXPIRED,
        'The {0} has expired!',
    );

    static PARAM_NOT_ACTIVATED = new ErrorObject(
        ErrorCode.DATA_NOT_ACTIVATED,
    ...
    static DATA_INVALID = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'Data is invalid!',
    );

    static PARAM_INVALID = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The {0} is invalid!',
    );
    ...
    static PARAM_MAX_NUMBER = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The maximum number of {0} is {1}!',
    );

    static PARAM_MIN_MAX_NUMBER = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The {0} number field must be at least {1} and a maximum of {2}!',
    );

    static PARAM_SIZE_MAX = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The size of {0} must be a maximum of {1} ({2})!',
    );

    static PARAM_LEN_EQUAL = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be {1}!',
    );

    static PARAM_LEN_AT_LEAST = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be at least {1}!',
    );

    static PARAM_LEN_AT_LEAST_AND_MAX = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be at least {1} and maximum {2}!',
    );

    static PARAM_LEN_AT_LEAST_AND_MAX_SPECIAL = new ErrorObject(
        ErrorCode.DATA_INVALID,
    ...
    static PARAM_LEN_MAX = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be a maximum of {1}!',
    );

    static PARAM_LEN_LESS_OR_EQUAL = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be less than or equal to {1}!',
    );

    static PARAM_LEN_GREATER_OR_EQUAL = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be greater than or equal to {1}!',
    );

    static PARAM_LEN_BETWEEN = new ErrorObject(
        ErrorCode.DATA_INVALID,
        'The length of {0} must be between {1} and {2}!',
    );

    static CONNECTION_ERROR = new ErrorObject(
